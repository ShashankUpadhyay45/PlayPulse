...
export const mockPlayers = {
  ...
  "rohit-sharma": {
    ...
    stats: {
      "Format": ["Test", "ODI", "T20I"],
      "Matches": [59, 265, 159],
      "Runs": [4179, 10709, 4231],
      "Average": [45.42, 49.12, 32.05],
      "Strike Rate": [56.23, 92.43, 140.89],
      "100s/50s": ["12/17", "31/55", "5/32"]
    }
  },
  "lionel-messi": {
    id: "lionel-messi",
...
export const mockCommentaries = {
  ...
  "cricket-2": [
    { time: "19.3", event: "SIX", text: "Pathirana to MS Dhoni. SIX! Smashed over deep midwicket for a maximum! CSK WINS THE MATCH!" },
    { time: "19.2", event: "NORMAL", text: "Pathirana to MS Dhoni. 2 runs. Driven through cover." }
  ],
  "football-1": [
    ...
    { time: "71'", event: "GOAL", text: "GOAL! Real Madrid 2 - 1 Barcelona. Robert Lewandowski scores! A headers from Gundogan's corner." },
...
export const mockSquads = {
  "cricket-1": {
    team1Players: [
      { name: "Rohit Sharma", role: "Captain / Opening Batsman" },
  ...
  "cricket-2": {
    team1Players: [
      ...
      { name: "Hardik Pandya", role: "Captain / All-rounder" }
    ],
    team2Players: [
      { name: "MS Dhoni", role: "Captain / Wicketkeeper" },
